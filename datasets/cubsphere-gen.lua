--
--  Script to compute list of cub filenames and classes
--
--  This generates a file cubsphere.t7 which contains the list of all
--  CUB training and validation images and their classes. 
--
...
local function findClasses(dir)
   ...
   assert(#classList == 200, 'expected 200 CUB classes')
...
function M.exec(opt, cacheFile)
   ...
   local imageClass = torch.LongTensor() -- class index of each image
